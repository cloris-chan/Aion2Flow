...
public readonly record struct Skill(int SkillId, string Name, SkillCategory Category, SkillSourceType SourceType, string SourceKey, string? TriggeredSkillIdsCsv)
{
