...
public readonly record struct SkillDisplayEntry(int SkillId, string Name, SkillCategory Category, SkillSourceType SourceType, string SourceKey, string? TriggeredSkillIdsCsv)
{
