...
public sealed class CombatantRowViewModel(UiFrameBatchService frameBatchService, int id, CharacterClass? characterClass, double damagePerSecond, double healingPerSecond, double damage, double healing) : FrameBatchedObservableObject(frameBatchService)
{
