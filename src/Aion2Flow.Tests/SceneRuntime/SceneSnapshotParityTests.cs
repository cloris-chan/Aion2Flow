...
{
    [Fact]
    public void M5_02_VendoredStreamCorpus_SceneSnapshotMatchesBaselineOrAcceptedBoundary()
    {
    ...
    private readonly record struct SnapshotDiff(string Scope, string Key, string Field, string Baseline, string Scene)
    {
        public override string ToString() => $"{Scope}|{Key}|{Field}|baseline={Baseline}|scene={Scene}";
    }
