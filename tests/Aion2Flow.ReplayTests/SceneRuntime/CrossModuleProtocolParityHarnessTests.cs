...
public sealed class CrossModuleProtocolParityHarnessTests
{
    ...
    public void M4_12_SelectedReplays_MigratedModuleFactsMatchSceneCorpusExpectations()
    {
        ...
        AssertPeriodicLinkSceneInvariant(diffs, ReplayScenarioCatalog.PeriodicLinkInvariant);
        AssertCompactPrimarySceneInvariant(diffs, ReplayScenarioCatalog.CompactPrimaryInvariantA);
        AssertCompactPrimarySceneInvariant(diffs, ReplayScenarioCatalog.CompactPrimaryInvariantB);
        AssertMapIdentitySceneInvariant(diffs, ReplayScenarioCatalog.InstanceClearRestoreAndMapBoundary);
        AssertShieldAbsorbedSceneInvariant(diffs, ReplayScenarioCatalog.ShieldAbsorbedInvariant);
