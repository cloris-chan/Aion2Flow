...
public sealed class NumericBlockTests
{
    ...
    public void FormatsCommonValuesThroughNumericBlock(double value, bool useGrouping, bool useCompactNotation, bool usePercentageNotation, int fractionDigits, string? prefix, string? suffix, string expected)
    {
