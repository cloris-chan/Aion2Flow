...
public sealed class ResourcePackTests
{
    ...
    public void Load_Loads_Runtime_Shared_And_Locale_Packs(string language)
    {
        ...
        Assert.Equal(15_503, snapshot.SkillDefinitions.Count);
        Assert.Equal(15_503, snapshot.Skills.Count);
        Assert.Equal(12_614, snapshot.NpcCatalog.Count);
    ...
    public void RuntimeSemanticIndex_Loads_Compact_Current_Client_Index()
    {
        ...
        Assert.Equal(16_248, runtime.SkillCount);
        Assert.Equal(25_408, runtime.SlotCount);
