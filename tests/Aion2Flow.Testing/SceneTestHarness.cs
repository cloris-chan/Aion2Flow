...
public sealed class SceneTestHarness : IDisposable
{
    ...
    private sealed class HarnessSink(SceneTestHarness owner, IRuntimeObservationSink inner) : IRuntimeObservationSink
    {
        ...
        public void RegisterCompactControl0238(in PacketObservationSource packet, int sourceId, int bodySkillVariantRaw, ResourceEffectRef bodyResourceEffectRef, int marker, int echoSourceId) => inner.RegisterCompactControl0238(in packet, sourceId, bodySkillVariantRaw, bodyResourceEffectRef, marker, echoSourceId);
        public void RegisterCompactControl0638(in PacketObservationSource packet, int sourceId, int bodySkillVariantRaw, ResourceEffectRef bodyResourceEffectRef, int marker, int flag) => inner.RegisterCompactControl0638(in packet, sourceId, bodySkillVariantRaw, bodyResourceEffectRef, marker, flag);
