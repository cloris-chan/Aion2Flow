...
public sealed class SceneTestHarness : IDisposable
{
    ...
    public void AppendNickname(int uid, string nickname, Faction faction = Faction.Unknown, CharacterClass? characterClass = null, bool isLocalPlayer = false, int? originServerId = null) => Sink.AppendNickname(NextSource(), uid, nickname, faction, characterClass, isLocalPlayer, originServerId);
    ...
    private sealed class HarnessSink(SceneTestHarness owner, IRuntimeObservationSink inner) : IRuntimeObservationSink
    {
        ...
        public void AppendNickname(in PacketObservationSource packet, int uid, string nickname, Faction faction = Faction.Unknown, CharacterClass? characterClass = null, bool isLocalPlayer = false, int? originServerId = null) => inner.AppendNickname(in packet, uid, nickname, faction, characterClass, isLocalPlayer, originServerId);
