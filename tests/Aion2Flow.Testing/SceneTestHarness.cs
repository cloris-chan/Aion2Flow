...
public sealed class SceneTestHarness : IDisposable
{
    ...
    private sealed class HarnessSink(SceneTestHarness owner, IRuntimeObservationSink inner) : IRuntimeObservationSink
    {
        ...
        public void RegisterObservation2C38(in PacketObservationSource packet, int instanceId, int mode, int sequenceId, int resultCode, int tailFirstValue, int tailUInt32Raw) => inner.RegisterObservation2C38(in packet, instanceId, mode, sequenceId, resultCode, tailFirstValue, tailUInt32Raw);
